    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        <input
          ...
          className="rounded-control border-border-strong focus:border-accent focus:ring-accent/20 bg-surface min-w-0 flex-1 border px-3.5 py-2 text-sm outline-none focus:ring-2"
        />
